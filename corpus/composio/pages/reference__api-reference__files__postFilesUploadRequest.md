---
url: https://docs.composio.dev/reference/api-reference/files/postFilesUploadRequest
...
API Reference [Files](https://docs.composio.dev/reference/api-reference/files)

# Create presigned URL for request file upload to S3v3.1
...
## [Authorization](https://docs.composio.dev/reference/api-reference/files/postFilesUploadRequest\#authorization)
...
## [Request Body](https://docs.composio.dev/reference/api-reference/files/postFilesUploadRequest\#request-body)
...
## [Response Body](https://docs.composio.dev/reference/api-reference/files/postFilesUploadRequest\#response-body)
...
```
curl -X POST "https://backend.composio.dev/api/v3.1/files/upload/request" \  -H "x-api-key: " \  -H "Content-Type: application/json" \  -d '{    "toolkit_slug": "gmail",    "tool_slug": "GMAIL_SEND_EMAIL",    "filename": "quarterly_report.pdf",    "mimetype": "application/pdf",    "md5": "a1b2c3d4e5f6a7b8c9d0e1f2a3b4c5d6"  }'
```
...
[Edit this page on GitHub](https://github.com/ComposioHQ/composio/blob/next/docs/content/reference/api-reference/files/postFilesUploadRequest.mdx)
