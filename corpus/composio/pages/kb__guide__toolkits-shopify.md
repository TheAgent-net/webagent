---
url: https://docs.composio.dev/kb/guide/toolkits-shopify
title: Shopify | Composio
description: Setup and troubleshooting guidance for Shopify in Composio.
status: 200
---
...
## [Configure Shopify authentication](https://docs.composio.dev/kb/guide/toolkits-shopify\#configure-shopify-authentication)
...
## [Discover and run Shopify tools](https://docs.composio.dev/kb/guide/toolkits-shopify\#discover-and-run-shopify-tools)
...
## [Work with Shopify orders](https://docs.composio.dev/kb/guide/toolkits-shopify\#work-with-shopify-orders)
...
[Configure Shopify authentication](https://docs.composio.dev/kb/guide/toolkits-shopify#configure-shopify-authentication) [Discover and run Shopify tools](https://docs.composio.dev/kb/guide/toolkits-shopify#discover-and-run-shopify-tools) [Work with Shopify orders](https://docs.composio.dev/kb/guide/toolkits-shopify#work-with-shopify-orders)
