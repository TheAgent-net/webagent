---
url: https://docs.composio.dev/kb/guide/platform-session-tool-policies
title: Create Read-Only and Restricted Composio Sessions | Composio
...
## [Filter a broad read-only session with behavior tags](https://docs.composio.dev/kb/guide/platform-session-tool-policies\#filter-a-broad-read-only-session-with-behavior-tags)
...
## [Use exact tool allowlists for the narrowest policy](https://docs.composio.dev/kb/guide/platform-session-tool-policies\#use-exact-tool-allowlists-for-the-narrowest-policy)
...
## [Combine provider scopes with session tool restrictions](https://docs.composio.dev/kb/guide/platform-session-tool-policies\#combine-provider-scopes-with-session-tool-restrictions)
...
## [Apply toolkit-specific exceptions without widening every toolkit](https://docs.composio.dev/kb/guide/platform-session-tool-policies\#apply-toolkit-specific-exceptions-without-widening-every-toolkit)
...
## [Disable the session sandbox when the workflow does not need code execution](https://docs.composio.dev/kb/guide/platform-session-tool-policies\#disable-the-session-sandbox-when-the-workflow-does-not-need-code-execution)
...
[Filter a broad read-only session with behavior tags](https://docs.composio.dev/kb/guide/platform-session-tool-policies#filter-a-broad-read-only-session-with-behavior-tags) [Use exact tool allowlists for the narrowest policy](https://docs.composio.dev/kb/guide/platform-session-tool-policies#use-exact-tool-allowlists-for-the-narrowest-policy) [Combine provider scopes with session tool restrictions](https://docs.composio.dev/kb/guide/platform-session-tool-policies#combine-provider-scopes-with-session-tool-restrictions) [Apply toolkit-specific exceptions without widening every toolkit](https://docs.composio.dev/kb/guide/platform-session-tool-policies#apply-toolkit-specific-exceptions-without-widening-every-toolkit) [Disable the session sandbox when the workflow does not need code execution](https://docs.composio.dev/kb/guide/platform-session-tool-policies#disable-the-session-sandbox-when-the-workflow-does-not-need-code-execution)
