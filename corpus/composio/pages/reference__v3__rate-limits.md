---
url: https://docs.composio.dev/reference/v3/rate-limits
...
## [Rate limits by plan](https://docs.composio.dev/reference/v3/rate-limits\#rate-limits-by-plan)
...
## [Rate limit headers](https://docs.composio.dev/reference/v3/rate-limits\#rate-limit-headers)
...
## [Rate limit response](https://docs.composio.dev/reference/v3/rate-limits\#rate-limit-response)
...
## [Best practices](https://docs.composio.dev/reference/v3/rate-limits\#best-practices)
...
## [Need higher limits?](https://docs.composio.dev/reference/v3/rate-limits\#need-higher-limits)
...
[**Errors** \\
\\
Understanding API error responses](https://docs.composio.dev/reference/v3/errors) [**Pricing** \\
\\
Compare plans and limits](https://composio.dev/pricing)

[Edit this page on GitHub](https://github.com/ComposioHQ/composio/blob/next/docs/content/reference/v3/rate-limits.mdx)

### On this page

[Rate limits by plan](https://docs.composio.dev/reference/v3/rate-limits#rate-limits-by-plan) [Rate limit headers](https://docs.composio.dev/reference/v3/rate-limits#rate-limit-headers) [Rate limit response](https://docs.composio.dev/reference/v3/rate-limits#rate-limit-response) [Best practices](https://docs.composio.dev/reference/v3/rate-limits#best-practices) [Need higher limits?](https://docs.composio.dev/reference/v3/rate-limits#need-higher-limits)
