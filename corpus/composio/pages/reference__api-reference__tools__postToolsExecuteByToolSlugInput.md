---
url: https://docs.composio.dev/reference/api-reference/tools/postToolsExecuteByToolSlugInput
...
# Generate tool inputs from natural languagev3.1
...
## [Authorization](https://docs.composio.dev/reference/api-reference/tools/postToolsExecuteByToolSlugInput\#authorization)
...
## [Path Parameters](https://docs.composio.dev/reference/api-reference/tools/postToolsExecuteByToolSlugInput\#parameters-path)

tool\_slugstringRequired

The tool slug to generate inputs for

## [Request Body](https://docs.composio.dev/reference/api-reference/tools/postToolsExecuteByToolSlugInput\#request-body)
...
Tool version to use when generating inputs. Defaults to the latest published version ("latest") when omitted.

## [Response Body](https://docs.composio.dev/reference/api-reference/tools/postToolsExecuteByToolSlugInput\#response-body)
...
```
curl -X POST "https://backend.composio.dev/api/v3.1/tools/execute/string/input" \
  -H "x-api-key: " \
...
[Edit this page on GitHub](https://github.com/ComposioHQ/composio/blob/next/docs/content/reference/api-reference/tools/postToolsExecuteByToolSlugInput.mdx)
