---
url: https://docs.composio.dev/kb/guide/toolkits-googlesuper
title: Google Super | Composio
description: Setup and troubleshooting guidance for Google Super in Composio.
status: 200
---
...
## [Configure Google Super access and consent](https://docs.composio.dev/kb/guide/toolkits-googlesuper\#configure-google-super-access-and-consent)
...
## [Enable service-specific scopes and APIs](https://docs.composio.dev/kb/guide/toolkits-googlesuper\#enable-service-specific-scopes-and-apis)
...
**Include the Gmail settings scope for filter creation.** Google Super uses the same underlying Gmail API requirement for filter creation. See the canonical Gmail guidance: [Creating Gmail filters requires `gmail.settings.basic`](https://docs.composio.dev/kb/guide/toolkits-gmail).
...
## [Query Gmail efficiently through Google Super](https://docs.composio.dev/kb/guide/toolkits-googlesuper\#query-gmail-efficiently-through-google-super)
...
[Configure Google Super access and consent](https://docs.composio.dev/kb/guide/toolkits-googlesuper#configure-google-super-access-and-consent) [Enable service-specific scopes and APIs](https://docs.composio.dev/kb/guide/toolkits-googlesuper#enable-service-specific-scopes-and-apis) [Query Gmail efficiently through Google Super](https://docs.composio.dev/kb/guide/toolkits-googlesuper#query-gmail-efficiently-through-google-super)
