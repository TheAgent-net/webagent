---
url: https://docs.composio.dev/kb/guide/platform-self-hosted-helm
title: Self-hosted Helm | Composio
description: Setup and troubleshooting guidance for Self-hosted Helm in Composio.
status: 200
---
...
## [Apollo S3 with IRSA / ServiceAccount credentials needs no static S3 secret keys](https://docs.composio.dev/kb/guide/platform-self-hosted-helm\#apollo-s3-with-irsa--serviceaccount-credentials-needs-no-static-s3-secret-keys)
...
## [Disable social login explicitly for self-hosted deployments](https://docs.composio.dev/kb/guide/platform-self-hosted-helm\#disable-social-login-explicitly-for-self-hosted-deployments)
...
[Apollo S3 with IRSA / ServiceAccount credentials needs no static S3 secret keys](https://docs.composio.dev/kb/guide/platform-self-hosted-helm#apollo-s3-with-irsa--serviceaccount-credentials-needs-no-static-s3-secret-keys) [Disable social login explicitly for self-hosted deployments](https://docs.composio.dev/kb/guide/platform-self-hosted-helm#disable-social-login-explicitly-for-self-hosted-deployments)
