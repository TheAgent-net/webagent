---
url: https://docs.composio.dev/reference/v3/api-reference/mcp/postMcpServersCustom
...
# Create a new custom MCP server with multiple appsv3.0Legacy
...
## [Authorization](https://docs.composio.dev/reference/v3/api-reference/mcp/postMcpServersCustom\#authorization)
...
## [Request Body](https://docs.composio.dev/reference/v3/api-reference/mcp/postMcpServersCustom\#request-body)
...
## [Response Body](https://docs.composio.dev/reference/v3/api-reference/mcp/postMcpServersCustom\#response-body)
...
[Edit this page on GitHub](https://github.com/ComposioHQ/composio/blob/next/docs/content/reference/v3/api-reference/mcp/postMcpServersCustom.mdx)
