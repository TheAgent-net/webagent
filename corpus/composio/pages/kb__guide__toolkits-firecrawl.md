---
url: https://docs.composio.dev/kb/guide/toolkits-firecrawl
title: Firecrawl | Composio
description: Setup and troubleshooting guidance for Firecrawl in Composio.
status: 200
---
...
## [Connect Firecrawl with an API key](https://docs.composio.dev/kb/guide/toolkits-firecrawl\#connect-firecrawl-with-an-api-key)
...
## [Discover and run Firecrawl tools](https://docs.composio.dev/kb/guide/toolkits-firecrawl\#discover-and-run-firecrawl-tools)
...
## [Configure endpoints and scrape timeouts](https://docs.composio.dev/kb/guide/toolkits-firecrawl\#configure-endpoints-and-scrape-timeouts)
...
## [Use Firecrawl with Connect MCP](https://docs.composio.dev/kb/guide/toolkits-firecrawl\#use-firecrawl-with-connect-mcp)
...
[Connect Firecrawl with an API key](https://docs.composio.dev/kb/guide/toolkits-firecrawl#connect-firecrawl-with-an-api-key) [Discover and run Firecrawl tools](https://docs.composio.dev/kb/guide/toolkits-firecrawl#discover-and-run-firecrawl-tools) [Configure endpoints and scrape timeouts](https://docs.composio.dev/kb/guide/toolkits-firecrawl#configure-endpoints-and-scrape-timeouts) [Use Firecrawl with Connect MCP](https://docs.composio.dev/kb/guide/toolkits-firecrawl#use-firecrawl-with-connect-mcp)
