---
url: https://docs.composio.dev/kb/guide/toolkits-instagram
title: Instagram | Composio
description: Setup and troubleshooting guidance for Instagram in Composio.
status: 200
---
...
## [Instagram OAuth tokens are bound to the account selected in Facebook Login](https://docs.composio.dev/kb/guide/toolkits-instagram\#instagram-oauth-tokens-are-bound-to-the-account-selected-in-facebook-login)
...
## [Instagram uses Business Login and only supported/verified scopes should be configured](https://docs.composio.dev/kb/guide/toolkits-instagram\#instagram-uses-business-login-and-only-supportedverified-scopes-should-be-configured)
...
## [Instagram toolkit requires a Business/Creator account for supported business features](https://docs.composio.dev/kb/guide/toolkits-instagram\#instagram-toolkit-requires-a-businesscreator-account-for-supported-business-features)
...
## [Use `INSTAGRAM_LIST_ALL_MESSAGES` to fetch Instagram messages](https://docs.composio.dev/kb/guide/toolkits-instagram\#use-instagram_list_all_messages-to-fetch-instagram-messages)
...
## [Instagram DM send failures with code 10/subcode 2534022 are Meta's 24-hour messaging window](https://docs.composio.dev/kb/guide/toolkits-instagram\#instagram-dm-send-failures-with-code-10subcode-2534022-are-metas-24-hour-messaging-window)
...
## [For custom Instagram/Meta OAuth, configure the redirect URI in the Meta app](https://docs.composio.dev/kb/guide/toolkits-instagram\#for-custom-instagrammeta-oauth-configure-the-redirect-uri-in-the-meta-app)
...
## [For Instagram DMs via n8n/Claude, Connect MCP can simplify setup](https://docs.composio.dev/kb/guide/toolkits-instagram\#for-instagram-dms-via-n8nclaude-connect-mcp-can-simplify-setup)
...
## [`INSTAGRAM_POST_IG_MEDIA_COMMENTS` failures can be caused by an incorrect `ig_media_id`](https://docs.composio.dev/kb/guide/toolkits-instagram\#instagram_post_ig_media_comments-failures-can-be-caused-by-an-incorrect-ig_media_id)
...
## [Instagram is available as a toolkit and can be connected via a new authConfig](https://docs.composio.dev/kb/guide/toolkits-instagram\#instagram-is-available-as-a-toolkit-and-can-be-connected-via-a-new-authconfig)
...
## [Publish local media with `image_file` or `video_file`](https://docs.composio.dev/kb/guide/toolkits-instagram\#publish-local-media-with-image_file-or-video_file)
...
[Instagram OAuth tokens are bound to the account selected in Facebook Login](https://docs.composio.dev/kb/guide/toolkits-instagram#instagram-oauth-tokens-are-bound-to-the-account-selected-in-facebook-login) [Instagram uses Business Login and only supported/verified scopes should be configured](https://docs.composio.dev/kb/guide/toolkits-instagram#instagram-uses-business-login-and-only-supportedverified-scopes-should-be-configured) [Instagram toolkit requires a Business/Creator account for supported business features](https://docs.composio.dev/kb/guide/toolkits-instagram#instagram-toolkit-requires-a-businesscreator-account-for-supported-business-features) [Use `INSTAGRAM_LIST_ALL_MESSAGES` to fetch Instagram messages](https://docs.composio.dev/kb/guide/toolkits-instagram#use-instagram_list_all_messages-to-fetch-instagram-messages) [Instagram DM send failures with code 10/subcode 2534022 are Meta's 24-hour messaging window](https://docs.composio.dev/kb/guide/toolkits-instagram#instagram-dm-send-failures-with-code-10subcode-2534022-are-metas-24-hour-messaging-window) [For custom Instagram/Meta OAuth, configure the redirect URI in the Meta app](https://docs.composio.dev/kb/guide/toolkits-instagram#for-custom-instagrammeta-oauth-configure-the-redirect-uri-in-the-meta-app) [For Instagram DMs via n8n/Claude, Connect MCP can simplify setup](https://docs.composio.dev/kb/guide/toolkits-instagram#for-instagram-dms-via-n8nclaude-connect-mcp-can-simplify-setup) [`INSTAGRAM_POST_IG_MEDIA_COMMENTS` failures can be caused by an incorrect `ig_media_id`](https://docs.composio.dev/kb/guide/toolkits-instagram#instagram_post_ig_media_comments-failures-can-be-caused-by-an-incorrect-ig_media_id) [Instagram is available as a toolkit and can be connected via a new authConfig](https://docs.composio.dev/kb/guide/toolkits-instagram#instagram-is-available-as-a-toolkit-and-can-be-connected-via-a-new-authconfig) [Publish local media with `image_file` or `video_file`](https://docs.composio.dev/kb/guide/toolkits-instagram#publish-local-media-with-image_file-or-video_file)
