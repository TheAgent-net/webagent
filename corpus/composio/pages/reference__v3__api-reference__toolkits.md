---
url: https://docs.composio.dev/reference/v3/api-reference/toolkits
...
## [Endpoints](https://docs.composio.dev/reference/v3/api-reference/toolkits\#endpoints)

| Endpoint | Quick Link |
| --- | --- |
| `GET /api/v3/toolkits` | [List available toolkits](https://docs.composio.dev/reference/v3/api-reference/toolkits/getToolkits) |
| `GET /api/v3/toolkits/categories` | [List toolkit categories](https://docs.composio.dev/reference/v3/api-reference/toolkits/getToolkitsCategories) |
| `POST /api/v3/custom/toolkits/upsert` | [Upsert a custom toolkit](https://docs.composio.dev/reference/v3/api-reference/toolkits/postCustomToolkitsUpsert) |
| `POST /api/v3/custom/toolkits/sync` | [Sync a custom toolkit](https://docs.composio.dev/reference/v3/api-reference/toolkits/postCustomToolkitsSync) |
| `GET /api/v3/toolkits/{slug}` | [Get toolkit by slug](https://docs.composio.dev/reference/v3/api-reference/toolkits/getToolkitsBySlug) |
| `POST /api/v3/toolkits/multi` | [Fetch multiple toolkits](https://docs.composio.dev/reference/v3/api-reference/toolkits/postToolkitsMulti) |
| `GET /api/v3/toolkits/changelog` | [Get toolkits changelog](https://docs.composio.dev/reference/v3/api-reference/toolkits/getToolkitsChangelog) |

[Edit this page on GitHub](https://github.com/ComposioHQ/composio/blob/next/docs/content/reference/v3/api-reference/toolkits/index.mdx)
