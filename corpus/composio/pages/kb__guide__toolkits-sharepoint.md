---
url: https://docs.composio.dev/kb/guide/toolkits-sharepoint
title: SharePoint | Composio
description: Setup and troubleshooting guidance for SharePoint in Composio.
status: 200
---
...
## [SharePoint REST APIs and SharePoint Graph are separate API families](https://docs.composio.dev/kb/guide/toolkits-sharepoint\#sharepoint-rest-apis-and-sharepoint-graph-are-separate-api-families)
...
## [`/teams/` SharePoint sites require the server-relative Subsite path](https://docs.composio.dev/kb/guide/toolkits-sharepoint\#teams-sharepoint-sites-require-the-server-relative-subsite-path)
...
## [SharePoint REST app-only client credentials use certificate auth](https://docs.composio.dev/kb/guide/toolkits-sharepoint\#sharepoint-rest-app-only-client-credentials-use-certificate-auth)
...
## [SharePoint `.default` scope uses the tenant domain placeholder](https://docs.composio.dev/kb/guide/toolkits-sharepoint\#sharepoint-default-scope-uses-the-tenant-domain-placeholder)
...
## [Pass the SharePoint tenant/subdomain during connection initiation](https://docs.composio.dev/kb/guide/toolkits-sharepoint\#pass-the-sharepoint-tenantsubdomain-during-connection-initiation)
...
## [The SharePoint subsite field is not a permission boundary](https://docs.composio.dev/kb/guide/toolkits-sharepoint\#the-sharepoint-subsite-field-is-not-a-permission-boundary)
...
## [Retrieve SharePoint site name from connected account state](https://docs.composio.dev/kb/guide/toolkits-sharepoint\#retrieve-sharepoint-site-name-from-connected-account-state)
...
## [Use `SHARE_POINT_SEARCH_QUERY` for KQL/FQL SharePoint search](https://docs.composio.dev/kb/guide/toolkits-sharepoint\#use-share_point_search_query-for-kqlfql-sharepoint-search)
...
## [SharePoint toolkit slug is `share_point`](https://docs.composio.dev/kb/guide/toolkits-sharepoint\#sharepoint-toolkit-slug-is-share_point)
...
## [Disable destructive SharePoint tools with `destructiveHint` or explicit tool filters](https://docs.composio.dev/kb/guide/toolkits-sharepoint\#disable-destructive-sharepoint-tools-with-destructivehint-or-explicit-tool-filters)
...
## [`SHARE_POINT_UPLOAD_FROM_URL` needs a server-fetchable URL](https://docs.composio.dev/kb/guide/toolkits-sharepoint\#share_point_upload_from_url-needs-a-server-fetchable-url)
...
[SharePoint REST APIs and SharePoint Graph are separate API families](https://docs.composio.dev/kb/guide/toolkits-sharepoint#sharepoint-rest-apis-and-sharepoint-graph-are-separate-api-families) [`/teams/` SharePoint sites require the server-relative Subsite path](https://docs.composio.dev/kb/guide/toolkits-sharepoint#teams-sharepoint-sites-require-the-server-relative-subsite-path) [SharePoint REST app-only client credentials use certificate auth](https://docs.composio.dev/kb/guide/toolkits-sharepoint#sharepoint-rest-app-only-client-credentials-use-certificate-auth) [SharePoint `.default` scope uses the tenant domain placeholder](https://docs.composio.dev/kb/guide/toolkits-sharepoint#sharepoint-default-scope-uses-the-tenant-domain-placeholder) [Pass the SharePoint tenant/subdomain during connection initiation](https://docs.composio.dev/kb/guide/toolkits-sharepoint#pass-the-sharepoint-tenantsubdomain-during-connection-initiation) [The SharePoint subsite field is not a permission boundary](https://docs.composio.dev/kb/guide/toolkits-sharepoint#the-sharepoint-subsite-field-is-not-a-permission-boundary) [Retrieve SharePoint site name from connected account state](https://docs.composio.dev/kb/guide/toolkits-sharepoint#retrieve-sharepoint-site-name-from-connected-account-state) [Use `SHARE_POINT_SEARCH_QUERY` for KQL/FQL SharePoint search](https://docs.composio.dev/kb/guide/toolkits-sharepoint#use-share_point_search_query-for-kqlfql-sharepoint-search) [SharePoint toolkit slug is `share_point`](https://docs.composio.dev/kb/guide/toolkits-sharepoint#sharepoint-toolkit-slug-is-share_point) [Disable destructive SharePoint tools with `destructiveHint` or explicit tool filters](https://docs.composio.dev/kb/guide/toolkits-sharepoint#disable-destructive-sharepoint-tools-with-destructivehint-or-explicit-tool-filters) [`SHARE_POINT_UPLOAD_FROM_URL` needs a server-fetchable URL](https://docs.composio.dev/kb/guide/toolkits-sharepoint#share_point_upload_from_url-needs-a-server-fetchable-url)
