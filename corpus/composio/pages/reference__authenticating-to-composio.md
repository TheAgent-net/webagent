---
url: https://docs.composio.dev/reference/authenticating-to-composio
title: Overview | Composio
...
## [Project API key](https://docs.composio.dev/reference/authenticating-to-composio\#project-api-key)
...
## [Organization API key](https://docs.composio.dev/reference/authenticating-to-composio\#organization-api-key)
...
## [Scoped project API key](https://docs.composio.dev/reference/authenticating-to-composio\#scoped-project-api-key)
...
See [Scoped project API keys](https://docs.composio.dev/reference/authenticating-to-composio/project-api-key-permissions) for the permission areas, access levels, and the routes each one covers.

[**Scoped project API keys** \\
\\
Permission areas, access levels, and covered routes](https://docs.composio.dev/reference/authenticating-to-composio/project-api-key-permissions) [**Errors** \\
\\
Understanding API error responses](https://docs.composio.dev/reference/errors) [**Rate Limits** \\
\\
API rate limits by plan](https://docs.composio.dev/reference/rate-limits)

[Edit this page on GitHub](https://github.com/ComposioHQ/composio/blob/next/docs/content/reference/authenticating-to-composio/index.mdx)

### On this page

[Project API key](https://docs.composio.dev/reference/authenticating-to-composio#project-api-key) [Organization API key](https://docs.composio.dev/reference/authenticating-to-composio#organization-api-key) [Scoped project API key](https://docs.composio.dev/reference/authenticating-to-composio#scoped-project-api-key)
