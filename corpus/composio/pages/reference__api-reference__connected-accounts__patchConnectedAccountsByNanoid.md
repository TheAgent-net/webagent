---
url: https://docs.composio.dev/reference/api-reference/connected-accounts/patchConnectedAccountsByNanoid
...
# Update a connected accountv3.1
...
## [Authorization](https://docs.composio.dev/reference/api-reference/connected-accounts/patchConnectedAccountsByNanoid\#authorization)
...
## [Path Parameters](https://docs.composio.dev/reference/api-reference/connected-accounts/patchConnectedAccountsByNanoid\#parameters-path)
...
## [Request Body](https://docs.composio.dev/reference/api-reference/connected-accounts/patchConnectedAccountsByNanoid\#request-body)
...
## [Response Body](https://docs.composio.dev/reference/api-reference/connected-accounts/patchConnectedAccountsByNanoid\#response-body)
...
```
curl -X PATCH "https://backend.composio.dev/api/v3.1/connected_accounts/ca_1a2b3c4d5e6f" \
  -H "x-api-key: " \
...
[Edit this page on GitHub](https://github.com/ComposioHQ/composio/blob/next/docs/content/reference/api-reference/connected-accounts/patchConnectedAccountsByNanoid.mdx)
