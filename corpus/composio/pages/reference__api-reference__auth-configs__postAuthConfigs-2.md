---
url: https://docs.composio.dev/reference/api-reference/auth-configs/postAuthConfigs?format=md
...
## [Authorization](https://docs.composio.dev/reference/api-reference/auth-configs/postAuthConfigs?format=md\#authorization)
...
## [Request Body](https://docs.composio.dev/reference/api-reference/auth-configs/postAuthConfigs?format=md\#request-body)
...
## [Response Body](https://docs.composio.dev/reference/api-reference/auth-configs/postAuthConfigs?format=md\#response-body)
