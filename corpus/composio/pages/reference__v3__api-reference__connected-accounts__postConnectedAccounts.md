---
url: https://docs.composio.dev/reference/v3/api-reference/connected-accounts/postConnectedAccounts
...
# Create a new connected accountv3.0
...
## [Authorization](https://docs.composio.dev/reference/v3/api-reference/connected-accounts/postConnectedAccounts\#authorization)
...
## [Request Body](https://docs.composio.dev/reference/v3/api-reference/connected-accounts/postConnectedAccounts\#request-body)
...
## [Response Body](https://docs.composio.dev/reference/v3/api-reference/connected-accounts/postConnectedAccounts\#response-body)
...
[Edit this page on GitHub](https://github.com/ComposioHQ/composio/blob/next/docs/content/reference/v3/api-reference/connected-accounts/postConnectedAccounts.mdx)
