---
url: https://docs.composio.dev/reference/v3/api-reference/connected-accounts
...
Composio creates a connected account when a user completes the flow defined by an [auth config](https://docs.composio.dev/reference/api-reference/auth-configs). From there you manage its full lifecycle:

- **Create or link**: start a new connection, or generate an auth link session for the user to authorize. See [manually authenticating users](https://docs.composio.dev/docs/authentication/manually-authenticating).
...
## [Link auth (Composio Connect Links)](https://docs.composio.dev/reference/v3/api-reference/connected-accounts\#link-auth-composio-connect-links)
...
By default a connected account is `PRIVATE` and usable only by its owning user. Mark one `SHARED` to let other users reach it through a per-connection access control list. See [shared connections](https://docs.composio.dev/docs/extending-sessions/shared-connections).
...
## [Callback identity verification](https://docs.composio.dev/reference/v3/api-reference/connected-accounts\#callback-identity-verification)
...
## [Endpoints](https://docs.composio.dev/reference/v3/api-reference/connected-accounts\#endpoints)

| Endpoint | Quick Link |
| --- | --- |
| `GET /api/v3/connected_accounts` | [List connected accounts with optional filters](https://docs.composio.dev/reference/v3/api-reference/connected-accounts/getConnectedAccounts) |
| `POST /api/v3/connected_accounts` | [Create a new connected account](https://docs.composio.dev/reference/v3/api-reference/connected-accounts/postConnectedAccounts) |
| `GET /api/v3/connected_accounts/{nanoid}` | [Get connected account details by ID](https://docs.composio.dev/reference/v3/api-reference/connected-accounts/getConnectedAccountsByNanoid) |
| `DELETE /api/v3/connected_accounts/{nanoid}` | [Delete a connected account](https://docs.composio.dev/reference/v3/api-reference/connected-accounts/deleteConnectedAccountsByNanoid) |
| `PATCH /api/v3/connected_accounts/{nanoid}` | [Update a connected account](https://docs.composio.dev/reference/v3/api-reference/connected-accounts/patchConnectedAccountsByNanoid) |
| `PATCH /api/v3/connected_accounts/{nanoId}/status` | [Enable or disable a connected account](https://docs.composio.dev/reference/v3/api-reference/connected-accounts/patchConnectedAccountsByNanoIdStatus) |
| `POST /api/v3/connected_accounts/{nanoid}/refresh` | [Re-initiate authentication for a connected account](https://docs.composio.dev/reference/v3/api-reference/connected-accounts/postConnectedAccountsByNanoidRefresh) Legacy |
| `POST /api/v3/connected_accounts/link` | [Create a new auth link session](https://docs.composio.dev/reference/v3/api-reference/connected-accounts/postConnectedAccountsLink) |

[Edit this page on GitHub](https://github.com/ComposioHQ/composio/blob/next/docs/content/reference/v3/api-reference/connected-accounts/index.mdx)

### On this page

[Link auth (Composio Connect Links)](https://docs.composio.dev/reference/v3/api-reference/connected-accounts#link-auth-composio-connect-links) [Callback identity verification](https://docs.composio.dev/reference/v3/api-reference/connected-accounts#callback-identity-verification) [Endpoints](https://docs.composio.dev/reference/v3/api-reference/connected-accounts#endpoints)
