---
url: https://docs.composio.dev/docs/providers/custom-providers/python
title: Python Custom Provider | Composio
...
## [Provider architecture](https://docs.composio.dev/docs/providers/custom-providers/python\#provider-architecture)
...
## [Quick start](https://docs.composio.dev/docs/providers/custom-providers/python\#quick-start)
...
## [Creating a non-agentic provider](https://docs.composio.dev/docs/providers/custom-providers/python\#creating-a-non-agentic-provider)
...
## [Creating an agentic provider](https://docs.composio.dev/docs/providers/custom-providers/python\#creating-an-agentic-provider)
...
## [Using your custom provider](https://docs.composio.dev/docs/providers/custom-providers/python\#using-your-custom-provider)

Pass an instance of your provider to `Composio`, and every tool you fetch comes back in your format.

### [Non-agentic provider](https://docs.composio.dev/docs/providers/custom-providers/python\#non-agentic-provider)
...
### [Agentic provider](https://docs.composio.dev/docs/providers/custom-providers/python\#agentic-provider)
...
## [Best practices](https://docs.composio.dev/docs/providers/custom-providers/python\#best-practices)
...
[Edit this page on GitHub](https://github.com/ComposioHQ/composio/blob/next/docs/content/docs/providers/custom-providers/python.mdx)

### On this page

[Provider architecture](https://docs.composio.dev/docs/providers/custom-providers/python#provider-architecture) [Quick start](https://docs.composio.dev/docs/providers/custom-providers/python#quick-start) [Creating a non-agentic provider](https://docs.composio.dev/docs/providers/custom-providers/python#creating-a-non-agentic-provider) [Creating an agentic provider](https://docs.composio.dev/docs/providers/custom-providers/python#creating-an-agentic-provider) [Using your custom provider](https://docs.composio.dev/docs/providers/custom-providers/python#using-your-custom-provider) [Non-agentic provider](https://docs.composio.dev/docs/providers/custom-providers/python#non-agentic-provider) [Agentic provider](https://docs.composio.dev/docs/providers/custom-providers/python#agentic-provider) [Best practices](https://docs.composio.dev/docs/providers/custom-providers/python#best-practices)
