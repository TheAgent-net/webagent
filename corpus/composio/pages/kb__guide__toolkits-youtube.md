---
url: https://docs.composio.dev/kb/guide/toolkits-youtube
title: YouTube | Composio
description: Setup and troubleshooting guidance for YouTube in Composio.
status: 200
---
...
## [Upload videos through current YouTube actions](https://docs.composio.dev/kb/guide/toolkits-youtube\#upload-videos-through-current-youtube-actions)
...
## [Troubleshoot YouTube processing and provider limits](https://docs.composio.dev/kb/guide/toolkits-youtube\#troubleshoot-youtube-processing-and-provider-limits)
...
## [Configure YouTube scopes and triggers](https://docs.composio.dev/kb/guide/toolkits-youtube\#configure-youtube-scopes-and-triggers)
...
[Upload videos through current YouTube actions](https://docs.composio.dev/kb/guide/toolkits-youtube#upload-videos-through-current-youtube-actions) [Troubleshoot YouTube processing and provider limits](https://docs.composio.dev/kb/guide/toolkits-youtube#troubleshoot-youtube-processing-and-provider-limits) [Configure YouTube scopes and triggers](https://docs.composio.dev/kb/guide/toolkits-youtube#configure-youtube-scopes-and-triggers)
