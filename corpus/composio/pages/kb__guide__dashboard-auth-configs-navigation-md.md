---
url: https://docs.composio.dev/kb/guide/dashboard-auth-configs-navigation.md
title: https://docs.composio.dev/kb/guide/dashboard-auth-configs-navigation.md
description: 
status: 200
---
...
\`user\_id\` and the intended auth config.
