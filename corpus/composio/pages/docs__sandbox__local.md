---
url: https://docs.composio.dev/docs/sandbox/local
title: Local sandbox | Composio
...
A **local sandbox** runs your agent's code in your own infrastructure instead of Composio's hosted [remote sandbox](https://docs.composio.dev/docs/sandbox/remote), so code execution never leaves your security boundary.
...
## [When to use it](https://docs.composio.dev/docs/sandbox/local\#when-to-use-it)
...
If none of that applies, use the [remote sandbox](https://docs.composio.dev/docs/sandbox/remote). It's the same helper surface with no infrastructure to run.

## [Create a local sandbox session](https://docs.composio.dev/docs/sandbox/local\#create-a-local-sandbox-session)

A local sandbox session is a [session](https://docs.composio.dev/docs/how-composio-works) created with the remote sandbox turned off. Set `workbench.enable: false`, then pass the session to `experimental_createLocalWorkbenchSession` (from the `@composio/experimental` package), which returns the two pieces you run yourself.
...
## [The helper contract](https://docs.composio.dev/docs/sandbox/local\#the-helper-contract)

`helperSource` is a Python module your agent imports. It exposes the same helpers the [remote sandbox](https://docs.composio.dev/docs/sandbox/remote#built-in-helpers) runs, with the same signatures, so the agent calls tools without knowing that execution is local:
...
If your agent needs one of the file helpers, use the [remote sandbox](https://docs.composio.dev/docs/sandbox/remote) for now.

## [Security: the sandbox is your boundary](https://docs.composio.dev/docs/sandbox/local\#security-the-sandbox-is-your-boundary)
...
## [Next](https://docs.composio.dev/docs/sandbox/local\#next)

[**What is a session?** \\
How sessions scope tools, auth, and sandbox state to a user](https://docs.composio.dev/docs/how-composio-works)

[Edit this page on GitHub](https://github.com/ComposioHQ/composio/blob/next/docs/content/docs/sandbox/local.mdx)

### On this page

[When to use it](https://docs.composio.dev/docs/sandbox/local#when-to-use-it) [Create a local sandbox session](https://docs.composio.dev/docs/sandbox/local#create-a-local-sandbox-session) [The helper contract](https://docs.composio.dev/docs/sandbox/local#the-helper-contract) [Security: the sandbox is your boundary](https://docs.composio.dev/docs/sandbox/local#security-the-sandbox-is-your-boundary) [Next](https://docs.composio.dev/docs/sandbox/local#next)

Related

- [Local sandbox PR reviewerA worked example: clone a PR into a sandbox you own and post one grounded review.](https://docs.composio.dev/examples/local-sandbox-pr-reviewer)
