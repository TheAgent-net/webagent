---
url: https://docs.composio.dev/kb/guide/platform-production-readiness
title: Move a Composio Integration from Prototype to Production | Composio
...
## [Replace example user IDs with stable application user IDs](https://docs.composio.dev/kb/guide/platform-production-readiness\#replace-example-user-ids-with-stable-application-user-ids)
...
## [Isolate environments with separate Composio projects when needed](https://docs.composio.dev/kb/guide/platform-production-readiness\#isolate-environments-with-separate-composio-projects-when-needed)
...
## [Switch from managed auth only when production requirements call for it](https://docs.composio.dev/kb/guide/platform-production-readiness\#switch-from-managed-auth-only-when-production-requirements-call-for-it)
...
## [Restrict the production session to the capabilities the agent needs](https://docs.composio.dev/kb/guide/platform-production-readiness\#restrict-the-production-session-to-the-capabilities-the-agent-needs)
...
- [Create read-only and restricted sessions](https://docs.composio.dev/kb/guide/platform-session-tool-policies)

## [Reuse a stored session until the user or configuration changes](https://docs.composio.dev/kb/guide/platform-production-readiness\#reuse-a-stored-session-until-the-user-or-configuration-changes)
...
## [Test production trigger handling through the real webhook path](https://docs.composio.dev/kb/guide/platform-production-readiness\#test-production-trigger-handling-through-the-real-webhook-path)
...
[Replace example user IDs with stable application user IDs](https://docs.composio.dev/kb/guide/platform-production-readiness#replace-example-user-ids-with-stable-application-user-ids) [Isolate environments with separate Composio projects when needed](https://docs.composio.dev/kb/guide/platform-production-readiness#isolate-environments-with-separate-composio-projects-when-needed) [Switch from managed auth only when production requirements call for it](https://docs.composio.dev/kb/guide/platform-production-readiness#switch-from-managed-auth-only-when-production-requirements-call-for-it) [Restrict the production session to the capabilities the agent needs](https://docs.composio.dev/kb/guide/platform-production-readiness#restrict-the-production-session-to-the-capabilities-the-agent-needs) [Reuse a stored session until the user or configuration changes](https://docs.composio.dev/kb/guide/platform-production-readiness#reuse-a-stored-session-until-the-user-or-configuration-changes) [Test production trigger handling through the real webhook path](https://docs.composio.dev/kb/guide/platform-production-readiness#test-production-trigger-handling-through-the-real-webhook-path)
