---
url: https://docs.composio.dev/kb/guide/toolkits-googletasks
title: Google Tasks | Composio
...
## [Configure Google OAuth for Google Tasks](https://docs.composio.dev/kb/guide/toolkits-googletasks\#configure-google-oauth-for-google-tasks)
...
## [Troubleshoot Google Tasks OAuth and tool calls](https://docs.composio.dev/kb/guide/toolkits-googletasks\#troubleshoot-google-tasks-oauth-and-tool-calls)
...
[Configure Google OAuth for Google Tasks](https://docs.composio.dev/kb/guide/toolkits-googletasks#configure-google-oauth-for-google-tasks) [Troubleshoot Google Tasks OAuth and tool calls](https://docs.composio.dev/kb/guide/toolkits-googletasks#troubleshoot-google-tasks-oauth-and-tool-calls)
